...
const MODE_GET_ALL_SUBMITTED_GRAPHS_SUMMARY = 16; // for RGG
const MODE_SUBMIT_GRAPH = 17; // for RGG
const MODE_GET_SUBMITTED_GRAPH_BY_ID = 18; // for RGG
const MODE_GET_ALL_GRAPH_TOPICS = 19; // for RGG
const MODE_DELETE_SUBMITTED_GRAPH = 20; // for RGG
const MODE_COMMIT_SUBMITTED_GRAPH = 21; // for RGG
const MODE_ADD_SUBMITTED_GRAPH_RATING = 22; // for RGG
const MODE_GET_RANDOM_SUBMITTED_GRAPH = 23; // for RGG