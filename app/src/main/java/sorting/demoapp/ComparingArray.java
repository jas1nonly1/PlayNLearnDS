...
public class ComparingArray extends Activity {
    ...
    private Runnable mPlayEnabler = new Runnable() {
            ...
            public void run() {
                    ...
                    if(mLeftSort.isFinished()==true && status1==false){
                  	long tEnd = System.currentTimeMillis();
                	long tDelta = tEnd - tStart;
                	double elapsedSeconds = tDelta / 1000.0;
                	txt1.setText(String.valueOf(elapsedSeconds));
                	txt1.setVisibility(View.VISIBLE);
                	status1 = true;
                    }
                    
                    if(mRightSort.isFinished()==true && status2==false){
                      	long tEnd = System.currentTimeMillis();
                    	long tDelta = tEnd - tStart;
                    	double elapsedSeconds = tDelta / 1000.0;
                    	txt2.setText(String.valueOf(elapsedSeconds));
...
public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_comparing_array);
    ...
    private View getView(int position, View convertView, int padding) {
            ...
            // check that convertView is available and represents the right component.
                    if(convertView != null && convertView.getId() == mResource) {
                            ...
                            LayoutInflater inflater = ComparingArray.this.getLayoutInflater();
